...
public class Bfs {
	public static void main(String[] args)
	{
        ...
        System.out.print("Enter the water in first jug- ");  
        int w1= sc.nextInt();  
		System.out.print(System.lineSeparator());
        System.out.print("Enter water in the second jug- ");  
        int w2= sc.nextInt();  
		System.out.print(System.lineSeparator());
		...
		while (!queue.isEmpty()) {
			...
			if (curr.j1 == target || curr.j2 == target) {
				if (curr.j1 == target) {
					...
					curr.path.add(new Pair(0,curr.j1));
				}
				else {
					curr.path.add(new Pair( curr.j2,0));
				}
